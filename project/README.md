...
Please write your proposal in a Google Doc (shared with comment access to anyone with the link) and submit a link to you proposal via [this form](https://forms.gle/WVeZUGDNsJwwgasY8).  We'll provide feedback as in-line comments, which can be more convenient than an email thread.
...
Please submit your PDF (and your project's code) to your course GitHub and then complete [this form](https://forms.gle/v3DcsmY5WTSpw4j88).
